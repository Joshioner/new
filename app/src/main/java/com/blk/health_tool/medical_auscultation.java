...
public class medical_auscultation extends Activity implements View.OnClickListener{
    private ImageView auscultation_back;
    private EditText editText;
    private ImageView btnStartSpeak;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpeechUtility.createUtility(medical_auscultation.this, SpeechConstant.APPID + "=578f1af7");
    ...
    private void initView() {
        ...
        btnStartSpeak = (ImageView) findViewById(R.id.btnStartSpeak);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.auscultation_back:
                Intent intent = new Intent(medical_auscultation.this, auscultation_detail.class);
                Bundle bundle = new Bundle();
                bundle.putInt("data", 1);
                intent.putExtras(bundle);
                medical_auscultation.this.finish();
            ...
            case R.id.btnStartSpeak:
                // 有交互动画的语音识别器
                iatDialog = new RecognizerDialog(medical_auscultation.this, mInitListener);
    ...
    private InitListener mInitListener = new InitListener() {
        ...
        public void onInit(int code) {
            ...
            if (code != ErrorCode.SUCCESS) {
                Toast.makeText(medical_auscultation.this, "初始化失败，错误码：" + code, Toast.LENGTH_SHORT).show();
            }
        }
    };
