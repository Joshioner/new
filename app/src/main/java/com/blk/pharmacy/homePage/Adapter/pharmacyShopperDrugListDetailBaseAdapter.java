...
public class pharmacyShopperDrugListDetailBaseAdapter extends BaseAdapter{
    private Context context;
    private List<pharmacy_shopper_drug_list_detail> list;

    public pharmacyShopperDrugListDetailBaseAdapter(Context context, List<pharmacy_shopper_drug_list_detail> list)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
        {
            convertView = LayoutInflater.from(context).inflate(R.layout.pharmacy_shopper_drug_list_detail,parent,false);
