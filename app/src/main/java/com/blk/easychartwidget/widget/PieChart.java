package com.blk.easychartwidget.widget;
...
import com.blk.easychartwidget.utils.CalculateUtil;
...
//            canvas.drawText("哈哈",pxs,pys,pxt,pyt,mLinePaint);
            ...
            if (startAngle % 360.0 >= 90.0 && startAngle % 360.0 <= 270.0) {//2 3 象限
              ...
              // canvas.drawText(resToRound+"%",pxt+30,pyt,mTextPaint);
               canvas.drawText(mDataList.get(i).getName(),pxt+30,pyt,mTextPaint);
            }
        }
